    ...
    <div class="evf-error-card evf-fade-in">
        ...
        <div class="evf-error-content">
            ...
            <div class="evf-error-help">
                <h3><?php _e('Ne yapabilirsiniz?', 'email-verification-forms'); ?></h3>
                <ul class="evf-help-list">
                    <li>
                        <strong><?php _e('Bağlantı süresi dolmuşsa:', 'email-verification-forms'); ?></strong>
                        <?php _e('Yeni bir kayıt denemesi yapın', 'email-verification-forms'); ?>
                    </li>
                    <li>
                        <strong><?php _e('Bağlantı geçersizse:', 'email-verification-forms'); ?></strong>
                        <?php _e('E-postanızı kontrol edin ve doğru bağlantıya tıklayın', 'email-verification-forms'); ?>
                    </li>
                    <li>
                        <strong><?php _e('Teknik sorun varsa:', 'email-verification-forms'); ?></strong>
                        <?php _e('Lütfen site yöneticisi ile iletişime geçin', 'email-verification-forms'); ?>
                    </li>
                </ul>
            </div>
            ...
            <div class="evf-error-actions">
                <a href="<?php echo wp_registration_url(); ?>" class="evf-btn evf-btn-primary">
                    <?php _e('Yeni Kayıt Denemesi', 'email-verification-forms'); ?>
                </a>
                <a href="<?php echo home_url(); ?>" class="evf-btn evf-btn-secondary">
            ...
            <div class="evf-contact-info">
                <p>
                    ...
                    <a href="mailto:<?php echo get_option('admin_email'); ?>" class="evf-contact-link">
        ...
        <div class="evf-error-details">
            <details class="evf-technical-details">
                <summary><?php _e('Teknik Detaylar', 'email-verification-forms'); ?></summary>
                <div class="evf-details-content">
                    <p><strong><?php _e('Zaman:', 'email-verification-forms'); ?></strong> <?php echo current_time('d.m.Y H:i:s'); ?></p>
                    <p><strong><?php _e('IP Adresi:', 'email-verification-forms'); ?></strong> <?php echo $_SERVER['REMOTE_ADDR']; ?></p>
                    <p><strong><?php _e('User Agent:', 'email-verification-forms'); ?></strong> <?php echo esc_html($_SERVER['HTTP_USER_AGENT']); ?></p>
                    <?php if (isset($_GET['evf_token'])): ?>
                    <p><strong><?php _e('Token:', 'email-verification-forms'); ?></strong> <?php echo esc_html(substr($_GET['evf_token'], 0, 8) . '...'); ?></p>
                    <?php endif; ?>
                </div>
            </details>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (errorMessage.includes('süresi dolmuş') || errorMessage.includes('expired')) {
        setTimeout(function() {
            if (confirm('<?php _e('Sayfa yeniden yüklensin mi?', 'email-verification-forms'); ?>')) {
